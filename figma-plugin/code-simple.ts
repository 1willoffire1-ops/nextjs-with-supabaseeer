...
async function loadFonts() {
  try {
    // Try Manrope font (user's preference)
...
async function generateLandingPage(frame: any, options: any) {
  ...
  setTextFont(heroTitle, FONT_STYLE_BOLD);
  ...
  setTextFont(featuresTitle, FONT_STYLE_BOLD);
...
async function generateDashboardPage(frame: any, options: any) {
  ...
  setTextFont(pageTitle, FONT_STYLE_BOLD);
