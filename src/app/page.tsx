        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 sm:py-32">
          ...
          <nav className="flex items-center justify-between mb-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/login" className="text-foreground-secondary hover:text-primary transition-colors">Sign In</Link>
              <Link href="/dashboard" className="btn-primary glow-pulse">
                Get Started
              </Link>
            </div>
          </nav>
          ...
          <div className="text-center max-w-4xl mx-auto fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/dashboard" className="btn-primary px-8 py-4">
                Start Free Trial
              </Link>
      ...
      <section className="relative py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-12 glow-pulse">
            ...
            <Link href="/dashboard" className="btn-primary px-8 py-4 inline-block">
