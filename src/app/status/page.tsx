...
export const metadata: Metadata = {
  title: 'System Status - VATANA',
  description: 'Real-time system status and health monitoring for VATANA',
}
...
async function getHealthData(): Promise<HealthData | null> {
  try {
    ...
    const res = await fetch(url, {
      cache: 'no-store',
      headers: {
        'User-Agent': 'VATANA-Status-Page/1.0'
      }
    })
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">Claude AI integration</div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">Vercel</span>
              </div>
              
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Region</span>
                <span className="font-medium text-gray-900 dark:text-gray-100">Washington, D.C. (iad1)</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">Node.js 22.x</span>
              </div>
        ...
        <div className="text-center mt-12 text-gray-500 dark:text-gray-400">
          <p>This page is automatically updated every 30 seconds.</p>
          <p className="mt-2">
            For support, contact{' '}
            <a href="mailto:support@vatana.io" className="text-blue-600 dark:text-blue-400 hover:underline">
              support@vatana.io
            </a>
          </p>
        </div>
